...
#################################### 12/7/2022 evaluate results for vhcc 2l 2jets 
...
#################################### 12/16/2022 evaluate results for vhcc 0l 2jets 
# python evaluate.py -n vhcc_hadded_all_tree_0L_zjets_sh2211_2jet_1tag_preprocessed \
...
#################################### 1/17/2022 evaluate results for vhcc 2l 2pjets
# python evaluate.py -n vhcc_hadded_all_tree_2L_zjets_sh2211_mva_2pjet_preprocessed \
...
#################################### 1/19/2022 evaluate results for vhcc 0l 2pjets 
python evaluate.py -n vhcc_hadded_all_tree_0L_zjets_sh2211_2pjet_preprocessed \
-v vhcc_hadded_all_tree_0L_zjets_fxfx_2pjet_preprocessed \
-e -1 -p /eos/user/${USER:0:1}/${USER}/workdir/hcc/carl/preprocessed/ -g zjets-0L-2pjet -t Nominal \
-f "mBB,dRBB,dPhiVBB,dEtaBB,MET,pTB1,pTB2,MEff,bin_bTagB1,bin_bTagB2,mBBJ,pTJ3,nTags,FlavB1,FlavB2,ntctags,nJ" \
-w EventWeight --scale-method minmax
